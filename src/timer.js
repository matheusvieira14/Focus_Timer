import {
    buttonPause, buttonPlay, buttonSettings,
    buttonStop, kitchenTimer, minutesDisplay,
    secondsDisplay
...
export {
    getMinutes, updateDisplay, countdown, timerTimeOut, updateMinutes, play,
    pause, resetControls, resetTimer, addTimer, reduceTimer
}
